...
<body class='sc5'>
                ...
                <div class="col-lg-6">
                    <div class="faq-three-left-part mb-20 rel rmb-75">
                        ...
                        <div class="experiences-years">
                            <span class="experiences-years__number">{{ $contact->years_experience }}</span>
                            <span class="experiences-years__text">Years Experiences</span>
                        </div>
                        <div class="counter-item counter-text-wrap">
                            <div class="counter-item__content">
                                <span class="count-text" data-speed="3000" data-stop="{{ $contact->volunteer_count }}">0</span>
                        ...
                        <div class="project-complete">
                            ...
                            <div class="project-complete__content">
                                <h5>We Complete {{ $contact->projects_completed }}+ Projects</h5>
                ...
                <div class="col-lg-6">
                    <div class="contact-page-form form-style-two py-110 rpy-85">
                        <div class="section-title mb-10">
                            <span class="section-title__subtitle mb-10">{{ $contact->form_subtitle }}</span>
                            <h3>{{ $contact->form_title }}</h3>
                        </div>
                        <form id="contactform0"  method="post" action="sendgrid/contact.php" >
                            <div class="row">
                                ...
                                <div class="g-recaptcha" data-sitekey="6LcYXeofAAAAACdvOPye5G2J15CpxsrbCAv7aGEs"></div>
                ...
                <div class="col-md-4 col-sm-6">
                    <div class="contact-info-item contact-info-item--green">
                        ...
                        <div class="contact-info__text">
                            <a href="tel:{{ preg_replace('/[^0-9+]/', '', $contact->phone) }}">{{ $contact->phone }}</a><br>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 col-sm-6">
    ...
    <div class="contact-page-map wow fadeInUp delay-0-2s">
        <div class="our-location">
            <iframe id="map-canvas" class="map_part" width="100%" height="450" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" src="{{ $contact->map_embed_url }}"></iframe>
        </div>
    </div>
    @endif
