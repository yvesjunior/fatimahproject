...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Fatimah Project Mission| Volunteers</title>
...
<body class='sc5'>
    ...
    <nav class="navbar py-30 navbar--one navbar-area navbar-expand-lg">
        <div class="container nav-container navbar-bg">
            ...
            <div class="nav-right-part nav-right-part-desktop">
                ...
                <a class="btn btn--style-two" href="/contact">Donate Now</a>
            </div>
        </div>
    </nav>
    <!-- navbar end -->
            ...
            <div class="row justify-content-center">
                <div class="col-xl-7 col-lg-8">
                    <div class="breadcrumb-inner text-center">
                        <h2 class="page-title">Our Volunteers</h2>
                        <ul class="page-list">
                            <li><a href="/">Home</a></li>
                            <li>Volunteers</li>
                        </ul>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="section-title text-center mb-60">
                        ...
                        <h2>Our <span>Volunteers</span> Style 01</h2>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="valunteer-item valunteer-item--green">
                        <div class="valunteer-item__img">
                            <img src="assets/img/valunteer/valunteer4.jpg" alt="Valunteer">
                            <div class="share">
                                <button><i class="flaticon-share"></i></button>
                                <div class="share__socials">
                                    <a href="#"><i class="flaticon-google-plus-logo"></i></a>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="valunteer-item">
                        <div class="valunteer-item__img">
                            <img src="assets/img/valunteer/valunteer5.jpg" alt="Valunteer">
                            <div class="share">
                                <button><i class="flaticon-share"></i></button>
                                <div class="share__socials">
                                    <a href="#"><i class="flaticon-google-plus-logo"></i></a>
                ...
                <div class="col-xl-4 col-sm-6">
                    <div class="valunteer-item valunteer-item--yellow">
                        <div class="valunteer-item__img">
                            <img src="assets/img/valunteer/valunteer6.jpg" alt="Valunteer">
                            <div class="share">
                                <button><i class="flaticon-share"></i></button>
                                <div class="share__socials">
                                    <a href="#"><i class="flaticon-google-plus-logo"></i></a>
    ...
    <!-- Volunteer area two start -->
    <div class="volunteer-style-two pb-90 rel z-1">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="section-title text-center mb-60">
                        <span class="section-title__subtitle mb-10">Our Volunteers</span>
                        <h2>Our <span>Volunteers</span> Style 02</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem autem voluptatem obcaecati
                            consectetur adipisicing</p>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="valunteer-two-item">
                        <div class="valunteer-two-item__img">
                            <img src="assets/img/valunteer/volunteer-two5.jpg" alt="Volunteer">
                        </div>
                        <div class="valunteer-two-item__des">
                            <h5>Brooklyn Simmons</h5>
                            <span>volunteer</span>
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="valunteer-two-item">
                        <div class="valunteer-two-item__img">
                            <img src="assets/img/valunteer/volunteer-two6.jpg" alt="Volunteer">
                        </div>
                        <div class="valunteer-two-item__des valunteer-two-item__des--yellow">
                            <h5>Savannah Nguyen</h5>
                            <span>volunteer</span>
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="valunteer-two-item">
                        <div class="valunteer-two-item__img">
                            <img src="assets/img/valunteer/volunteer-two7.jpg" alt="Volunteer">
                        </div>
                        <div class="valunteer-two-item__des valunteer-two-item__des--green">
                            <h5>Darrell Steward</h5>
                            <span>volunteer</span>
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="valunteer-two-item">
                        <div class="valunteer-two-item__img">
                            <img src="assets/img/valunteer/volunteer-two8.jpg" alt="Volunteer">
                        </div>
                        <div class="valunteer-two-item__des">
                            <h5>Leslie Alexander</h5>
                            <span>volunteer</span>
    ...
    <!-- Volunteer area two end -->


    <!-- Volunteer area three start -->
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-xl-6 col-lg-8 col-md-10">
                    <div class="section-title text-center mb-60">
                        <span class="section-title__subtitle mb-10">Our Volunteers</span>
                        <h2>Our <span>Volunteers</span> Style 03</h2>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rem autem voluptatem obcaecati
                            consectetur adipisicing</p>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-3 col-sm-6">
                    <div class="valunteer-item valunteer-item--three">
                        <div class="valunteer-item__img">
                            <img src="assets/img/valunteer/volunteer-three1.jpg" alt="Valunteer">
                        </div>
                        <div class="valunteer-item__designation">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="valunteer-item valunteer-item--three">
                        <div class="valunteer-item__img">
                            <img src="assets/img/valunteer/volunteer-three2.jpg" alt="Valunteer">
                        </div>
                        <div class="valunteer-item__designation">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="valunteer-item valunteer-item--three">
                        <div class="valunteer-item__img">
                            <img src="assets/img/valunteer/volunteer-three3.jpg" alt="Valunteer">
                        </div>
                        <div class="valunteer-item__designation">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="valunteer-item valunteer-item--three">
                        <div class="valunteer-item__img">
                            <img src="assets/img/valunteer/volunteer-three4.jpg" alt="Valunteer">
                        </div>
                        <div class="valunteer-item__designation">
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="valunteer-item valunteer-item--three">
                        <div class="valunteer-item__img">
                            <img src="assets/img/valunteer/volunteer-three5.jpg" alt="Valunteer">
                        </div>
                        <div class="valunteer-item__designation">
                            <h4>Brooklyn Simmons</h4>
                            <span>volunteer</span>
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="valunteer-item valunteer-item--three">
                        <div class="valunteer-item__img">
                            <img src="assets/img/valunteer/volunteer-three6.jpg" alt="Valunteer">
                        </div>
                        <div class="valunteer-item__designation">
                            <h4>Savannah Nguyen</h4>
                            <span>volunteer</span>
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="valunteer-item valunteer-item--three">
                        <div class="valunteer-item__img">
                            <img src="assets/img/valunteer/volunteer-three7.jpg" alt="Valunteer">
                        </div>
                        <div class="valunteer-item__designation">
                            <h4>Darrell Steward</h4>
                            <span>volunteer</span>
                ...
                <div class="col-xl-3 col-sm-6">
                    <div class="valunteer-item valunteer-item--three">
                        <div class="valunteer-item__img">
                            <img src="assets/img/valunteer/volunteer-three8.jpg" alt="Valunteer">
                        </div>
                        <div class="valunteer-item__designation">
                            <h4>Leslie Alexander</h4>
                            <span>volunteer</span>
