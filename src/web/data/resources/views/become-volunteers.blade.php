...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
    <title>Fatimah Project Mission| Become Volunteers</title>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="volunteer-content form-style-two">
                        ...
                        <form id="becomevoluntierform0"  method="post" action="sendgrid/volunteer.php" >
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="your-name" name="your-name" class="form-control" value=""
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="your-email" id="your-email" name="your-email" class="form-control" value=""
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="tel" id="your-phone" name="your-phone" class="form-control"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="your-message" id="your-message" class="form-control" rows="2"
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-10">
                    <div class="section-title text-center text-white">
                        ...
                        <a class="btn mt-35" href="/contact">Support Our Mission Today</a>
                    </div>
                </div>
            </div>
        </div>
